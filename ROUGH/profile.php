        		...
        		<div class="card-body">
        			<form method="post" id="profile_form">
					    ...
					    <div class="form-group">
					        ...
					        <input type="text" name="user_mobile_no" id="user_mobile_no" class="form-control" value="<?php echo $row["user_national_type"]; ?>" />
					    </div>
					    <div class="form-group">
					        <label>National ID Number</label>
					        <input type="text" name="user_mobile_no" id="user_mobile_no" class="form-control" value="<?php echo $row["user_national_no"]; ?>" />
					    </div>					    					    
					    ...
					    <?php if($row['is_profile_editable'] == '1'){ ?>

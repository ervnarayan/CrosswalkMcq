<?php
  ...
  include('header.php');
?>
  <div class="jumbotron text-center" style="margin-bottom:0; padding: 0rem 1rem;">
      <img src="assets/Images/logo.png" class="img-fluid" width="250" alt="Crosswalk MCQs Drill" />
  </div>
  <div class="container">
      <div class="row">
        <div class="col-md-3">
